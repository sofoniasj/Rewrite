...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormSuccess(
        data.message ||
          'Registration successful! Please check your email inbox (and spam folder) for the verification link to activate your account.'
      );
        ...
        <form onSubmit={handleSubmit} className="mt-3">
          ...
          <div className="form-check mb-3">
            <input
              ...
              disabled={loading}
            />
            <label htmlFor="terms" className="form-check-label text-sm">
              I agree to the{' '}
